<template>
	<div class="main">
		...
		<div class="vipCardCtrl">
			...
			<div v-if="vipInfo" class="vipCard" :style="{ 'background-image': 'url(' + $domain + '/mine/' + vipInfo.img + ')' }">
				<div class="vipContent">
					<!-- 未申请时不显示 -->
					<div class="left" style="display: flex;flex-direction: column;" @click="visible = true">
						<img v-if="userInfo.avatar" :src="user.avatar ? user.avatar : $domain + '/' + userInfo.avatar"
					...
					<template #header="{ close, titleId, titleClass }">
						<div class="my-header flex center" style="">
							<div class="avatar flex" style="">
								<el-upload class="avatar-uploader" action="https://www.soulmatemeet.vip:168/upload"
